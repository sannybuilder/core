    ...
    fn test_binary_assignment() {
        for game in [Game::gta3, Game::vc, Game::sa, Game::lcs, Game::sa_mobile] {
            t!(
                for game => (
                    ...
                    "$1020 -= 1" => "000C: $1020 1",
                    "$TEMPVAR_Z_COORD -= 0.5" => "000D: $TEMPVAR_Z_COORD 0.5",
                    "0@ -= 1" => "000E: 0@ 1",
                    "692@ -= 8.0" => "000F: 692@ 8.0",
                    "$GS_GANG_CASH *= 100" => "0010: $GS_GANG_CASH 100",
                    "$HJ_TEMP_FLOAT *= 100.0" => "0011: $HJ_TEMP_FLOAT 100.0",
                    "22@ *= -1" => "0012: 22@ -1",
                    "17@ *= 9.8" => "0013: 17@ 9.8",
                    "$HJ_TWOWHEELS_TIME /= 1000" => "0014: $HJ_TWOWHEELS_TIME 1000",
                    "$EXPORT_PRICE_HEALTH_MULTIPLIER /= 1000.0" => "0015: $EXPORT_PRICE_HEALTH_MULTIPLIER 1000.0",
                    "4@ /= 2" => "0016: 4@ 2",
                    "14@ /= 1000.0" => "0017: 14@ 1000.0"
                )
            );
        }
        ...
        t! {
            for Game::vcs => (
                ...
                "$_372 -= 1 // (int)" => "0009: $_372 1",
                "$2259(0@,30) -= 180.0 // (float)" => "000A: $2259(0@,30) 180.0",
                "1@ *= 2 // (int)" => "000B: 1@ 2",
                "5@ *= 100.0 // (float)" => "000C: 5@ 100.0",
                "1@ /= 2 // (int)" => "000D: 1@ 2",
                "40@ /= 3000.0 // (float)" => "000E: 40@ 3000.0"
            )
        };
    }
